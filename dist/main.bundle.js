...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return UserApi; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return OnboardingApi; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return WalletApi; });
...
var AssetPoolListComponent = (function () {
    function AssetPoolListComponent(assetPoolService, router, toastService, userService) {
        this.assetPoolService = assetPoolService;
        this.router = router;
        this.toastService = toastService;
        this.userService = userService;
    ...
    AssetPoolListComponent.prototype.getPools = function () {
        var _this = this;
        this.assetPoolService.getPools().subscribe(function (pools) {
            _this.pools = pools;
            console.log(pools);
            _this.getPoolInfoFromBlockchain();
        }, function (err) {
            console.log(err);
        });
    };
    AssetPoolListComponent.prototype.getPoolInfoFromBlockchain = function () {
        var _this = this;
        var arr = [];
...
var AssetPoolViewComponent = (function () {
    function AssetPoolViewComponent(activatedRoute, assetPoolService, toastService) {
    ...
    AssetPoolViewComponent = __decorate([
        ...
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* ActivatedRoute */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* ActivatedRoute */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_4__services_assets_pool_service__["a" /* AssetsPoolService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__services_assets_pool_service__["a" /* AssetsPoolService */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_3__services_toast_service__["a" /* ToastService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__services_toast_service__["a" /* ToastService */]) === "function" && _c || Object])
...
var AssetsPoolService = (function () {
    function AssetsPoolService(http, errorHandler) {
        this.http = http;
    ...
    AssetsPoolService = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["C" /* Injectable */])(),
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_8__angular_common_http__["b" /* HttpClient */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_8__angular_common_http__["b" /* HttpClient */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_9__error_handler_service__["a" /* ErrorHandlerService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_9__error_handler_service__["a" /* ErrorHandlerService */]) === "function" && _b || Object])
    ], AssetsPoolService);
...
var UserService = (function () {
    ...
    UserService.prototype.login = function (user) {
        var _this = this;
        return this.http.post(__WEBPACK_IMPORTED_MODULE_1__api_config__["d" /* UserApi */].login.url() + "?include=User", user)
            .do(function (res) {
    ...
    UserService.prototype.getUser = function () {
        ...
        return this.http.get(__WEBPACK_IMPORTED_MODULE_1__api_config__["d" /* UserApi */].findById.url() + "/" + this.getUserId());
    };
    ;
    ...
    UserService.prototype.changePassword = function (oldPassword, newPassword) {
        var _this = this;
        return this.http.post("" + __WEBPACK_IMPORTED_MODULE_1__api_config__["d" /* UserApi */].changePassword.url(), { oldPassword: oldPassword, newPassword: newPassword }).do(function (data) {
    ...
    UserService.prototype.logout = function () {
        var _this = this;
        return this.http.post("" + __WEBPACK_IMPORTED_MODULE_1__api_config__["d" /* UserApi */].logout.url(), {}).do(function (data) {
            _this.resetState();
            localStorage.removeItem('accessToken');
            localStorage.removeItem('userId');
        });
    ...
    UserService.prototype.getUsersByRole = function (role) {
        ...
        return this.http.get(__WEBPACK_IMPORTED_MODULE_1__api_config__["d" /* UserApi */].list.url() + "?filter[where][role]=" + role)
            .do(function (farmers) {
            console.log(farmers);
        })
            .catch(function (res) {
...
var WalletService = (function () {
    ...
    WalletService.prototype.getBlockchainAccount = function () {
        ...
        return this.userService.getUser()
            ...
            console.log(user);
            return _this.http.get(__WEBPACK_IMPORTED_MODULE_1__api_config__["e" /* WalletApi */].getAccount.url() + "?address=" + user.walletAddress);
        })
            .retry(3)
            .catch(function (res) {
            return _this.errorHandler.handle(res);
    ...
    WalletService.prototype.getTransactions = function () {
        ...
        return this.userService.getUser()
            .concatMap(function (user) {
            console.log(user);
            return _this.http.get(__WEBPACK_IMPORTED_MODULE_1__api_config__["e" /* WalletApi */].getTransaction.url() + "?senderPublicKey=" + user.publicKey + "&recipientId=" + user.walletAddress);
        }).retry(3)
            .catch(function (res) {
            return _this.errorHandler.handle(res);
        });
