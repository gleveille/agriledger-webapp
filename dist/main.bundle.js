...
var AccountComponent = (function () {
    ...
    AccountComponent.prototype.updateProfile = function (f, isValid) {
        var _this = this;
        if (!isValid) {
            return;
        }
