...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return UserApi; });
/* unused harmony export ProfileApi */
/* unused harmony export BlockChainApi */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return OnboardingApi; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return WalletApi; });
...
var WalletApi = {
    getAccount: {
        url: function () { return ServerUrl + '/api/blockchain/account'; },
        method: 'GET',
        params: 'address'
    },
    getTransaction: {
        url: function () { return ServerUrl + '/api/blockchain/transactions'; },
        method: 'GET',
...
var AssetApi = {
    ...
    getCategories: {
        url: function () { return ServerUrl + '/api/blockchain/category'; },
        method: 'GET',
        params: []
    }
};
var OnboardingApi = {
    ...
    resgisterIssuer: {
        url: function () { return ServerUrl + '/api/blockchain/issuer'; },
        method: 'POST',
        params: 'address'
    }
};
var marketApi = {
    ...
    "getTradingArea": {
        "url": function () { return ServerUrl + "/api/markets/getTransactionInfoOfCurrency"; },
        "method": "POST"
    },
    //Recommended exercise
    "recommededExcercise": {
        "url": function () { return ServerUrl + "/api/markets/web/homeexercise"; },
        "method": "POST"
    },
    "login": {
        "url": function () { return ServerUrl + "/api/markets/login"; },
        "method": "POST"
    },
    "getUserInfo": {
        "url": function () { return ServerUrl + "/api/markets/getUserInfo"; },
        "method": "POST"
    }
};
var BlockChainApi = {
    "loginApi": {
        "url": function () { return BlockChainServerUrl + "/api/accounts/open2"; }
    },
    //	余额账单Apiget /api/accounts?address=4205898691220223329L
    "accountApi": {
        "url": function () { return BlockChainServerUrl + "/api/accounts"; }
    },
    "transactionsApi": {
        "url": function () { return BlockChainServerUrl + "/api/transactions"; }
    },
    // 获取受托人接口
    "delegatesApi": {
        "mock": "/data/vote/delegates.json",
        "url": function () { return BlockChainServerUrl + "/api/delegates"; }
    },
    // 获取我的投票列表借口
    "myvotesApi": {
        "mock": "/data/vote/delegates.json",
        "url": function () { return BlockChainServerUrl + "/api/accounts/delegates"; }
    },
    // 获取我的投票列表借口
    "blocksApi": {
        "mock": "/data/blockchain/blocks.json",
        "url": function () { return BlockChainServerUrl + "/api/blocks"; }
    },
    //受托人的基本信息
    "blockforgingApi": {
        "mock": "/data/blockforging/delegates.json",
        "url": function () { return BlockChainServerUrl + "/api/delegates/get"; }
    },
    //详情基本信息
    "blocksDetailApi": {
        "mock": "/data/blockDetail/getblocks.json",
        "url": function () { return BlockChainServerUrl + "/api/blocks/get"; }
    },
    //账户基本信息
    "accountdetailApi": {
    ...
    "votetomeApi": {
        ...
        "url": function () { return BlockChainServerUrl + "/api/delegates/voters"; }
    },
    //节点列表
    "peerApi": {
        "mock": "/data/peer/peers.json",
        "url": function () { return BlockChainServerUrl + "/api/peers"; }
    },
    "postApi": {
        "mock": "/data/vote/delegates.json",
        "url": function () { return BlockChainServerUrl + "/peer/transactions"; }
    },
    "appListApi": {
        "mock": "/data/application/applist.json",
        "url": function () { return BlockChainServerUrl + "/api/dapps"; }
    },
    "appInstalledApi": {
        "mock": "/data/application/applist.json",
        "url": function () { return BlockChainServerUrl + "/api/dapps/installed"; }
    },
    "forgingStatusApi": {
        "mock": "/data/blockforging/status.json",
        "url": function () { return BlockChainServerUrl + "/api/delegates/forging/status"; }
    },
    ///api/uia/balances/:address
    "myBalancesApi": {
        "mock": "/data/assets/my-balances.json",
        "url": function () { return BlockChainServerUrl + "/api/uia/balances"; }
    },
    //api/uia/issuers/:address
    "issuerApi": {
        "mock": "/data/assets/issuer.json",
        "url": function () { return BlockChainServerUrl + "/api/uia/issuers"; }
    },
    ...
    "myTransactionsApi": {
        ...
        "url": function () { return BlockChainServerUrl + "/api/uia/transactions/:address"; }
    },
    // 获取资产访问控制列表
    "assetAclApi": {
        "mock": "/data/assets/acl.json",
        "url": function () { return BlockChainServerUrl + "/api/uia/assets/:name/acl/:flag"; }
    },
    //added 2017/04/29
    //获取资产评估-待审核列表
    "assetPendingApi": {
        "mock": "/data/assetevaluation/assetPending.json",
        "url": function () { return BlockChainServerUrl + "/api/uia/assets/applying"; }
    },
    //获取资产评估-发行待审核列表
    "publishpendingApi": {
        "mock": "/data/assetevaluation/publishPending.json",
        "url": function () { return BlockChainServerUrl + "/api/uia/issues/applying"; }
    },
    //获取资产评估-发行资产投票详情
    "publishvoterApi": {
        "mock": "/data/assetevaluation/publishvoter.json",
        "url": function () { return BlockChainServerUrl + "/api/uia/issues/:id/voters"; }
    },
    //获取资产评估-已通过列表
    "assetApprovedApi": {
        "mock": "/data/assetevaluation/assetApproved.json",
        "url": function () { return BlockChainServerUrl + "/api/uia/assets/approved"; }
    },
    //获取资产评估-注册待审核及已通过资产投票详情
    "assetvoterApi": {
        "mock": "/data/assetevaluation/assetvoter.json",
        "url": function () { return BlockChainServerUrl + "/api/uia/assets/:currency/voters"; }
    },
    //获取资产评估-资产详情
    "assetdetailApi": {
        "mock": "/data/assetdetail/assetdetail.json",
        "url": function () { return BlockChainServerUrl + "/api/uia/assets/:currency"; }
    },
    //注册资产-获取资产类别
    "assetcategoryApi": {
        "mock": "/data/assets/category.json",
        "url": function () { return BlockChainServerUrl + "/api/uia/categories/0"; }
    },
    //
    //api/uia/categories/:id
    "assetcategorynextApi": {
        "url": function () { return BlockChainServerUrl + "/api/uia/categories"; }
    },
    //Home-获取具体交易信息
    "transactiondetailApi": {
        "url": function () { return BlockChainServerUrl + "/api/transactions/get"; }
    }
};
...
module.exports = "<!--\n<div class=\"main-content\">\n<div class=\"container-fluid\">\n    <div class=\"row\">\n     &lt;!&ndash;   <div class=\"col-md-12\">\n            <div class=\"card\">\n                <div class=\"card-header\" data-background-color=\"green\">\n                    <h4 class=\"title\">My Profile</h4>\n                    <p class=\"category\">Reach us, to make changes to your Profile</p>\n                </div>\n                <div class=\"card-content\">\n                    <form>\n                        <div class=\"row\">\n                            <div class=\"col-md-5\">\n                                <div class=\"form-group form-black\">\n                                    <label class=\"control-label\">Company</label>\n                                    <input type=\"text\" class=\"form-control\" value=\"Agriledger\" disabled>\n                                </div>\n                            </div>\n                            <div class=\"col-md-3\">\n                                <div class=\"form-group form-black  \">\n                                    <label class=\"control-label\">Username</label>\n                                    <input type=\"text\" class=\"form-control\" >\n                                </div>\n                            </div>\n                            <div class=\"col-md-4\">\n                                <div class=\"form-group form-black  \">\n                                    <label class=\"control-label\">Email address</label>\n                                    <input type=\"email\" class=\"form-control\" >\n                                </div>\n                            </div>\n                        </div>\n\n                        <div class=\"row\">\n                            <div class=\"col-md-6\">\n                                <div class=\"form-group form-black  \">\n                                    <label class=\"control-label\">Phone</label>\n                                    <input type=\"tel\" class=\"form-control\" >\n                                </div>\n                            </div>\n                            <div class=\"col-md-6\">\n                                <div class=\"form-group form-black  \">\n                                    <label class=\"control-label\">Wallet Address</label>\n                                    <input type=\"text\" class=\"form-control\" >\n                                </div>\n                            </div>\n                        </div>\n\n                        <div class=\"row\">\n                            <div class=\"col-md-6\">\n                                <div class=\"form-group form-black  \">\n                                    <label class=\"control-label\">Last Login</label>\n                                    <input type=\"text\" class=\"form-control\" >\n                                </div>\n                            </div>\n                            <div class=\"col-md-6\">\n                                <div class=\"form-group form-black  \">\n                                    <label class=\"control-label\">Is Issuer on Blockchain</label>\n                                    <input type=\"text\" class=\"form-control\" >\n                                </div>\n                            </div>\n                        </div>\n\n                        <div class=\"row\">\n                            <div class=\"col-md-12\">\n                                <div class=\"form-group\">\n                                    <label>About Me</label>\n                                    <div class=\"form-group form-black  \">\n                                        <textarea class=\"form-control\" rows=\"3\"></textarea>\n                                    </div>\n                                </div>\n                            </div>\n                        </div>\n\n                        &lt;!&ndash;<button type=\"submit\" class=\"btn btn-danger pull-right\">Update Profile</button>&ndash;&gt;\n                        <div class=\"clearfix\"></div>\n                    </form>\n                </div>\n            </div>\n        </div>&ndash;&gt;\n\n        <div class=\"col-md-8 col-md-offset-2 \">\n            <div class=\"card card-profile\">\n                <div class=\"card-avatar\">\n                    <a href=\"javascipt:void(0)\">\n                        <img class=\"img\" src=\"../assets/img/default-avatar.png\" />\n                    </a>\n                </div>\n\n                <div class=\"content\" style=\"padding-left: 20px;padding-right: 20px;\">\n                    <h4 class=\"card-title\" style=\"text-transform: capitalize\">{{user?.name}} </h4>\n                    <p class=\"text-gray\">\n                        <span>{{user?.email}}</span>\n                        &nbsp;\n                        <span style=\"border:0.5px solid  #999999;\"></span>\n                        &nbsp;\n                        <span>{{user?.phone||'Mob. not available'}}</span>\n                    </p>\n\n                    <div class=\" card-content\">\n                        <div class=\"col-md-4 \">\n                            <div *ngIf=\"user?.isRegisteredOnBlockchain\" class=\"form-group label-floating has-success\">\n                                <label class=\"control-label\">Blockchain Account</label>\n                                <input [disabled]=\"true\" type=\"text\" value=\"Active\" class=\"form-control\" />\n                                <span class=\"form-control-feedback\">\n                                    <i class=\"material-icons\">done</i>\n                                </span>\n                            </div>\n\n                            <div *ngIf=\"!user?.isRegisteredOnBlockchain\" class=\"form-group label-floating has-error\">\n                                <label class=\"control-label\">Blockchain Account</label>\n                                <input [disabled]=\"true\" type=\"text\" value=\"Inactive\" class=\"form-control\" />\n                                <span class=\"material-icons form-control-feedback\">clear</span>\n\n                            </div>\n\n\n                        </div>\n\n\n\n\n                        <div *ngIf=\"user?.isRegisteredOnBlockchain\"  class=\"col-md-4\">\n                            <div class=\"form-group label-floating has-success\">\n                                <label class=\"control-label\">Initial ACC Transfered</label>\n                                <input [disabled]=\"true\" type=\"text\" value=\"100 ACC\" class=\"form-control\" />\n                                <span class=\"form-control-feedback\">\n                                    <i class=\"material-icons\">done</i>\n                                </span>\n                            </div>\n\n                            <div  *ngIf=\"!user?.isRegisteredOnBlockchain\" class=\"form-group label-floating has-error\">\n                                <label class=\"control-label\">Initial ACC Transfered</label>\n                                <input [disabled]=\"true\" type=\"text\" value=\"Pending\" class=\"form-control\" />\n                                <span class=\"material-icons form-control-feedback\">clear</span>\n\n                            </div>\n\n\n                        </div>\n\n                        <div class=\"col-md-4\">\n                            <div *ngIf=\"user?.isIssuerOnBlockchain\"  class=\"form-group label-floating has-success\">\n                                <label class=\"control-label\">Issuer Account</label>\n                                <input [disabled]=\"true\" type=\"text\" value=\"Active\" class=\"form-control\" />\n                                <span class=\"form-control-feedback\">\n                                    <i class=\"material-icons\">done</i>\n                                </span>\n                            </div>\n\n                            <div *ngIf=\"!user?.isIssuerOnBlockchain\"  class=\"form-group label-floating has-error\">\n                                <label class=\"control-label\">Issuer Account</label>\n                                <input [disabled]=\"true\" type=\"text\" value=\"Inactive\" class=\"form-control\" />\n                                <span class=\"material-icons form-control-feedback\">clear</span>\n\n                            </div>\n\n\n                        </div>\n\n\n                    </div>\n\n                    <p>\n                        <i class=\"material-icons\">info_outline</i>\n                        <span  style=\"position: relative;bottom: 7px;\" class=\"text-gray\">To change any information please contact us</span>\n                    </p>\n\n&lt;!&ndash;\n                    <a href=\"#pablo\" class=\"btn btn-danger btn-round\">Follow</a>\n&ndash;&gt;\n                </div>\n\n\n\n\n            </div>\n        </div>\n\n\n\n    </div>\n</div>\n</div>\n\n-->\n\n\n<div class=\"main-content\">\n    <div class=\"container-fluid\">\n        <div class=\"row\">\n            <div class=\"col-lg-8 col-lg-offset-2\">\n                <div class=\"card\">\n                    <div class=\"card-header\" data-background-color=\"green\">\n                        <h4 class=\"title\">My Account</h4>\n                    </div>\n                    <div class=\"card-content\" style=\"margin-top: 30px;\">\n                        <div class=\" card-profile\">\n                            <div class=\"card-avatar\" style=\"width: 60px;height: 60px;\">\n                                <a href=\"javascipt:void(0)\">\n                                    <img class=\"img\" src=\"../assets/img/default-avatar.png\"/>\n                                </a>\n                            </div>\n\n                            <div class=\"content\" style=\"padding-left: 20px;padding-right: 20px;\">\n                                <h4 class=\"card-title\" style=\"text-transform: capitalize\">{{user?.name}} </h4>\n                                <p class=\"text-gray\">\n                                    <span>{{user?.email}}</span>\n                                    &nbsp;\n                                    <span style=\"border:0.5px solid  #999999;\"></span>\n                                    &nbsp;\n                                    <span>{{user?.phone||'Mobile unavailable'}}</span>&nbsp;\n\n\n\n                                </p>\n                                <p class=\"text-gray\">\n                                    <b>Wallet Address: {{user?.walletAddress}}</b>\n\n                                </p>\n\n                                <div class=\" card-content\">\n                              <!--      <div class=\"col-md-6 \">\n                                        <div class=\"form-group label-floating has-success\">\n                                            <label class=\"control-label\">Blockchain Account</label>\n                                            <input [disabled]=\"true\" type=\"text\" value=\"Registered\" class=\"form-control\"/>\n                                                <span class=\"form-control-feedback\">\n                                    <i class=\"material-icons\">done</i>\n                                </span>\n                                        </div>\n\n\n\n                                    </div>\n\n\n                                    <div class=\"col-md-6\">\n                                        <div class=\"form-group label-floating has-success\">\n                                            <label class=\"control-label\">Issuer Account</label>\n                                            <input [disabled]=\"true\" type=\"text\" value=\"Active\" class=\"form-control\"/>\n                                                <span class=\"form-control-feedback\">\n                                    <i class=\"material-icons\">done</i>\n                                </span>\n                                        </div>\n\n\n                                    </div>-->\n\n\n                                </div>\n\n                                <hr>\n                                <p>\n                                    <i class=\"material-icons\">info_outline</i>\n                                    <span style=\"position: relative;bottom: 7px;\" class=\"text-gray\">To change any information please contact us at\n                                        help@agriledger.co</span>\n                                </p>\n\n                                <!--\n                                                    <a href=\"#pablo\" class=\"btn btn-danger btn-round\">Follow</a>\n                                -->\n                            </div>\n\n\n                        </div>\n\n                    </div>\n                </div>\n            </div>\n        </div>\n    </div>\n</div>\n\n"
...
module.exports = "<div class=\"main-content\">\n  <div class=\"container-fluid\">\n    <div class=\"row\">\n\n      <div class=\"col-md-12\">\n        <div class=\"card\">\n          <div class=\"card-header\" data-background-color=\"green\">\n              <h4 class=\"title\">Assets</h4>\n              <p class=\"category\">\n                <button class=\"btn btn-danger\"  (click)=\"goToCreateAssetPoolPage()\" >Create Asset Pool</button>\n\n              </p>\n\n\n\n          </div>\n\n          <div class=\"row\" style=\"padding: 15px;\">\n            <div class=\"col-xs-12\">\n              <div class=\"dropdown\" style=\"float: left\">\n                <a href=\"#\" class=\"btn dropdown-toggle\" data-toggle=\"dropdown\">\n                  Category 1\n                  <span style=\"font-weight: bolder\" *ngIf=\"assetCategoriesLevelOne[selectedIndexOnLevelOne]?.name\">\n                  ({{assetCategoriesLevelOne[selectedIndexOnLevelOne]?.name}})\n                </span>\n                  <b class=\"caret\"></b>\n                </a>\n                <ul class=\"dropdown-menu\">\n                  <li *ngFor=\"let category of assetCategoriesLevelOne;let i=index\">\n                    <a style=\"text-transform: capitalize\" href=\"javascript:void(0)\" (click)=\"selectCategory(i,1,category.id)\">\n                      {{category.name}}\n                    </a>\n                  </li>\n\n\n                </ul>\n              </div>\n\n\n              <div class=\"dropdown\" style=\"float: left\" >\n                <a href=\"#\" class=\"btn dropdown-toggle\" data-toggle=\"dropdown\">\n                  Category 2\n                  <span style=\"font-weight: bolder\" *ngIf=\"assetCategoriesLevelTwo[selectedIndexOnLevelTwo]\">\n                  ({{assetCategoriesLevelTwo[selectedIndexOnLevelTwo]?.name}})\n                </span>\n                  <b class=\"caret\"></b>\n                </a>\n                <ul class=\"dropdown-menu\">\n                  <li *ngFor=\"let category of assetCategoriesLevelTwo;let i=index\">\n                    <a style=\"text-transform: capitalize\" (click)=\"selectCategory(i,2,category.id)\" href=\"javascript:void(0)\">\n                      {{category.name}}\n\n                    </a>\n                  </li>\n\n\n                </ul>\n              </div>\n\n              <div class=\"dropdown\" style=\"float: left\" >\n                <a href=\"#\" class=\"btn dropdown-toggle\" data-toggle=\"dropdown\">\n                  Category 3\n                  <span style=\"font-weight: bolder\" *ngIf=\"assetCategoriesLevelThree[selectedIndexOnLevelThree]\">\n\n                  ({{assetCategoriesLevelThree[selectedIndexOnLevelThree]?.name||'unselected'}})\n                  </span>\n                  <b class=\"caret\"></b>\n                </a>\n                <ul class=\"dropdown-menu\">\n                  <li *ngFor=\"let category of assetCategoriesLevelThree;let i=index\">\n                    <a style=\"text-transform: capitalize\" (click)=\"selectCategory(i,3,category.id)\" href=\"javascript:void(0)\">\n                      {{category.name}}\n\n                    </a>\n                  </li>\n\n\n                </ul>\n              </div>\n\n\n              <div class=\"dropdown\" style=\"float: left\" >\n                <a href=\"#\" class=\"btn dropdown-toggle\" data-toggle=\"dropdown\">\n                  Category 4\n                  <span style=\"font-weight: bolder\" *ngIf=\"assetCategoriesLevelFour[selectedIndexOnLevelFour]\">\n                    ({{assetCategoriesLevelFour[selectedIndexOnLevelFour]?.name||'unselected'}})\n\n                  </span>\n                  <b class=\"caret\"></b>\n                </a>\n                <ul class=\"dropdown-menu\">\n                  <li *ngFor=\"let category of assetCategoriesLevelFour;let i=index\">\n                    <a style=\"text-transform: capitalize\" (click)=\"selectCategory(i,4,category.id)\" href=\"javascript:void(0)\">\n                      {{category.name}}\n\n                    </a>\n                  </li>\n\n\n                </ul>\n              </div>\n\n\n              <div class=\"dropdown\" style=\"float: left\">\n                <a href=\"#\" class=\"btn dropdown-toggle\" data-toggle=\"dropdown\">\n                  Category 5\n                  <span style=\"font-weight: bolder\" *ngIf=\"assetCategoriesLevelFive[selectedIndexOnLevelFive]\">\n                   ({{assetCategoriesLevelFive[selectedIndexOnLevelFive]?.name||'unselected'}})\n                  </span>\n                  <b class=\"caret\"></b>\n                </a>\n                <ul class=\"dropdown-menu\">\n                  <li *ngFor=\"let category of assetCategoriesLevelFive;let i=index\">\n                    <a style=\"text-transform: capitalize\" (click)=\"selectCategory(i,5,category.id)\" href=\"javascript:void(0)\">\n                      {{category.name}}\n\n                    </a>\n                  </li>\n\n\n                </ul>\n              </div>\n\n<!--\n              <button class=\"btn btn-info\" [disabled]=\"!selectedId\"  (click)=\"getAssets(selectedId)\" >SEARCH by Category</button>\n-->\n\n\n<!--\n              <div class=\"dropdown\" style=\"float: left\">\n                <a href=\"#\" class=\"btn dropdown-toggle\" data-toggle=\"dropdown\">\n                  Filter by Status <span style=\"font-weight: bolder\" [hidden]=\"!chosenStatus\">({{chosenStatus}})</span>\n                  <b class=\"caret\"></b>\n                </a>\n                <ul class=\"dropdown-menu\">\n                  <li><a href=\"javascript:void(0)\" (click)=\"getAssets('status','pending')\">Pending</a></li>\n                  <li><a href=\"javascript:void(0)\" (click)=\"getAssets('status','verified')\">Available</a></li>\n                  <li><a href=\"javascript:void(0)\" (click)=\"getAssets('status','pooled')\">Pooled</a></li>\n\n                </ul>\n              </div>-->\n\n\n            </div>\n\n\n\n          </div>\n\n\n          <div class=\"card-content table-responsive\">\n\n            <h3 class=\"text-center text-gray\" *ngIf=\"assetsRequestStatus==='resolved' && !assets.length \">\n              No Assets Available!\n\n            </h3>\n\n            <app-error-show *ngIf=\"assetsRequestStatus==='rejected'\" [error]=\"'Assets could not be fetched.Try again!'\">\n\n            </app-error-show>\n\n            <app-spinner *ngIf=\"assetsRequestStatus==='pending'\" [type]=\"'bounce'\"></app-spinner>\n\n\n            <table class=\"table\" *ngIf=\"assetsRequestStatus==='resolved' && assets.length \">\n              <thead  >\n              <tr >\n                <th class=\"boldfont\">Asset Name</th>\n                <th class=\"boldfont\">Farmer Name</th>\n\n                <th class=\"boldfont\">Description</th>\n                <th class=\"boldfont\">Quantity</th>\n                <th class=\"boldfont\">Status</th>\n\n              </tr>\n              </thead>\n              <tbody>\n\n\n\n              <tr *ngFor=\"let asset of assets\"  >\n                <td><span>\n                  <input type=\"checkbox\" [(ngModel)]=\"asset.isSelected\">\n                </span>\n                  <span style=\"position:relative;top:-3px;\">{{asset?.name}}</span></td>\n                <td style=\"cursor: pointer\" [routerLink]=\"['../assets',asset.id]\">{{asset?.user?.name}}</td>\n                <td style=\"cursor: pointer\" [routerLink]=\"['../assets',asset.id]\">{{asset?.description}}</td>\n\n                <td style=\"cursor: pointer\" [routerLink]=\"['../assets',asset.id]\">{{asset?.quantity}}</td>\n                <td [style.color]=\"getColor(asset.status)\"\n                    style=\"text-transform: capitalize;font-weight: bold;\n                    cursor: pointer\"\n                    [routerLink]=\"['../assets',asset.id]\">{{asset?.status}}</td>\n\n              </tr>\n              </tbody>\n            </table>\n\n          </div>\n        </div>\n      </div>\n    </div>\n  </div>\n</div>\n"
...
var AssetsComponent = (function () {
    ...
    AssetsComponent.prototype.selectCategory = function (index, level, id) {
        this.selectedId = id;
    ...
    AssetsComponent.prototype.goToCreateAssetPoolPage = function () {
        ...
        if (!this.isDeepestLevelSelected) {
            var currentLevel = this.selectedLevel;
            switch (currentLevel) {
                case 1:
        ...
        var selectedAssets = this.assets.filter(function (asset) {
        ...
        var firstId = selectedAssets[0].category;
        var isAllIdSame = true;
...
var DashboardSponserComponent = (function () {
    ...
    DashboardSponserComponent.prototype.ngAfterViewInit = function () {
        this.runOnRouteChange();
    };
    DashboardSponserComponent.prototype.isMaps = function (path) {
    ...
    DashboardSponserComponent.prototype.runOnRouteChange = function () {
        if (window.matchMedia("(min-width: 960px)").matches && !this.isMac()) {
            var elemMainPanel = document.querySelector('.main-panel');
            var ps = new __WEBPACK_IMPORTED_MODULE_4_perfect_scrollbar__["a" /* default */](elemMainPanel);
            ps.update();
    ...
    DashboardSponserComponent.prototype.isMac = function () {
        var bool = false;
    ...
    DashboardSponserComponent = __decorate([
        ...
        __metadata("design:paramtypes", [typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1__angular_common__["f" /* Location */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_common__["f" /* Location */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_3__angular_router__["d" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__angular_router__["d" /* Router */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_6__services_wallet_service__["a" /* WalletService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_6__services_wallet_service__["a" /* WalletService */]) === "function" && _d || Object])
...
var IssuerRegistrationComponent = (function () {
    ...
    IssuerRegistrationComponent = __decorate([
        ...
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__services_user_service__["a" /* UserService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__services_user_service__["a" /* UserService */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_4__angular_router__["d" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__angular_router__["d" /* Router */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_2_ng2_toasty__["c" /* ToastyService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2_ng2_toasty__["c" /* ToastyService */]) === "function" && _c || Object])
...
var WalletComponent = (function () {
    function WalletComponent(walletService, router, toastService) {
        this.walletService = walletService;
        this.router = router;
        this.toastService = toastService;
        this.account = {};
...
var AssetsService = (function () {
    ...
    AssetsService.prototype.getAssets = function (categoryId) {
        var _this = this;
        var url = __WEBPACK_IMPORTED_MODULE_1__api_config__["a" /* AssetApi */].getAssets.url() + "?filter[where][category][like]=^" + categoryId + "&filter[include]=user";
...
var UserService = (function () {
    ...
    UserService.prototype.login = function (user) {
        var _this = this;
        return this.http.post(__WEBPACK_IMPORTED_MODULE_1__api_config__["c" /* UserApi */].login.url() + "?include=User", user)
            .do(function (res) {
    ...
    UserService.prototype.getUser = function () {
        ...
        return this.http.get(__WEBPACK_IMPORTED_MODULE_1__api_config__["c" /* UserApi */].findById.url() + "/" + this.getUserId());
    };
    ;
    ...
    UserService.prototype.changePassword = function (oldPassword, newPassword) {
        var _this = this;
        return this.http.post("" + __WEBPACK_IMPORTED_MODULE_1__api_config__["c" /* UserApi */].changePassword.url(), { oldPassword: oldPassword, newPassword: newPassword }).do(function (data) {
    ...
    UserService.prototype.logout = function () {
        var _this = this;
        return this.http.post("" + __WEBPACK_IMPORTED_MODULE_1__api_config__["c" /* UserApi */].logout.url(), {}).do(function (data) {
            _this.resetState();
            localStorage.removeItem('accessToken');
            localStorage.removeItem('userId');
        });
    ...
    UserService.prototype.createAccountOnBlockchain = function () {
        var _this = this;
        return this.http.post("" + __WEBPACK_IMPORTED_MODULE_1__api_config__["b" /* OnboardingApi */].createAccount.url(), { userId: this.user.id })
            .do(function (data) {
    ...
    UserService.prototype.getUsersByRole = function (role) {
        ...
        return this.http.get(__WEBPACK_IMPORTED_MODULE_1__api_config__["c" /* UserApi */].list.url() + "?filter[where][role]=" + role)
            .do(function (farmers) {
            console.log(farmers);
        })
            .catch(function (res) {
    ...
    UserService.prototype.getBlockchainAccountDuringOnboarding = function () {
        ...
        return __WEBPACK_IMPORTED_MODULE_7_rxjs_Observable__["Observable"].interval(1000)
            ...
            console.log(val);
            return _this.http.get(__WEBPACK_IMPORTED_MODULE_1__api_config__["b" /* OnboardingApi */].getAccount.url() + "?address=" + _this.user.walletAddress);
        })
            .retry(3)
            .catch(function (res) {
            return _this.errorHandler.handle(res);
    ...
    UserService.prototype.resgisterAsIssuer = function (issuer) {
        var _this = this;
        return this.http.post("" + __WEBPACK_IMPORTED_MODULE_1__api_config__["b" /* OnboardingApi */].resgisterIssuer.url(), issuer).do(function (data) {
            console.log(data);
...
var WalletService = (function () {
    ...
    WalletService.prototype.getBlockchainAccount = function () {
        ...
        return this.userService.getUser()
            ...
            console.log(user);
            return _this.http.get(__WEBPACK_IMPORTED_MODULE_1__api_config__["d" /* WalletApi */].getAccount.url() + "?address=" + user.walletAddress);
        })
            .retry(3)
            .catch(function (res) {
            return _this.errorHandler.handle(res);
    ...
    WalletService.prototype.getTransactions = function () {
        ...
        return this.userService.getUser()
            .concatMap(function (user) {
            console.log(user);
            return _this.http.get(__WEBPACK_IMPORTED_MODULE_1__api_config__["d" /* WalletApi */].getTransaction.url() + "?senderPublicKey=" + user.publicKey + "&recipientId=" + user.walletAddress);
        }).retry(3)
            .catch(function (res) {
            return _this.errorHandler.handle(res);
        });
...
module.exports = "<h5 class=\"text-center text-gray\">\n  {{error}}\n</h5>"
