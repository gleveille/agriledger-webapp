...
var AssetPoolListComponent = (function () {
    function AssetPoolListComponent(assetPoolService, modalService, toastService, userService) {
        ...
        this.user = {};
        this.filters = [{ name: 'My pools', value: 'my', role: ['sponsor'] },
    ...
    AssetPoolListComponent.prototype.filterChange = function (name, value) {
        if (value === 'my') {
            this.getMyPools();
        }
        else
    ...
    AssetPoolListComponent.prototype.ngOnInit = function () {
        ...
        this.userService.getUser().subscribe(function (user) {
            ...
            if (user.role === 'sponsor') {
                _this.selectedFilter = 'My pools';
                _this.getMyPools();
            }
            else {
                _this.selectedFilter = 'All pools';
                _this.getOtherPools();
            }
        }, function (err) {
            console.log(err);
...
var AssetsComponent = (function () {
    function AssetsComponent(assetsService, assetPoolService, toastService, router) {
        ...
        this.onPoolSelect = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["v" /* EventEmitter */]();
...
var UserCreateComponent = (function () {
    function UserCreateComponent(userService, toastService, router) {
        ...
        this.toastService = toastService;
        this.router = router;
        this.user = { password: '', role: 'farmer' };
...
var UserService = (function () {
    ...
    UserService.prototype.resgisterAsIssuer = function (issuer) {
        ...
        return this.http.post("" + __WEBPACK_IMPORTED_MODULE_1__api_config__["c" /* OnboardingApi */].resgisterIssuer.url(), issuer).do(function (data) {
            ...
            _this.user.issuerName = issuer.name;
        }).catch(function (res) {
            return _this.errorHandler.handle(res);
        });
    };
