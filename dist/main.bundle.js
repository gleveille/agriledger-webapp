...
var UserCreateComponent = (function () {
    function UserCreateComponent(userService, toastService, router) {
        ...
        this.user = { password: '', role: 'farmer', profiles: { name: '', phone: '', address: { line1: '', line2: '', city: '', province: '' } } };
...
var TokenService = (function () {
    ...
    TokenService.prototype.getTokens = function (issuerName) {
        ...
        var url;
        if (issuerName) {
            url = __WEBPACK_IMPORTED_MODULE_1__api_config__["f" /* TokenApi */].getTokens.url() + "?filter[where][issuerName]=" + issuerName + "&filter[include]=assetpool";
        }
        else {
            url = __WEBPACK_IMPORTED_MODULE_1__api_config__["f" /* TokenApi */].getTokens.url() + "?filter[include]=assetpool";
        }
        return this.http.get("" + url)
            .catch(function (res) {
            return _this.errorHandler.handle(res);
