...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return ServerUrl; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "g", function() { return UserApi; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return OnboardingApi; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "h", function() { return WalletApi; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return TokenApi; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_56__components_password_new_password_new_component__ = __webpack_require__("../../../../../src/app/components/password-new/password-new.component.ts");
...
var AccountComponent = (function () {
    function AccountComponent(userService, toastService, modalService) {
        ...
        this.serverUrl = __WEBPACK_IMPORTED_MODULE_5__src_app_api_config__["e" /* ServerUrl */];
...
var AssetPoolListComponent = (function () {
    function AssetPoolListComponent(assetPoolService, modalService, toastService, userService) {
        this.assetPoolService = assetPoolService;
        this.modalService = modalService;
        this.toastService = toastService;
        this.userService = userService;
    ...
    AssetPoolListComponent.prototype.getPoolInfoFromBlockchain = function (pools) {
        ...
        Object(__WEBPACK_IMPORTED_MODULE_5_rxjs_observable_forkJoin__["a" /* forkJoin */])(arr).subscribe(function (results) {
...
var AssetPoolViewComponent = (function () {
    ...
    AssetPoolViewComponent.prototype.issueToken = function () {
        var _this = this;
        if (!this.token.amount) {
            this.toastService.error('Issue', 'Invalid amount');
            return;
...
var AssetsComponent = (function () {
    ...
    AssetsComponent.prototype.getAllAssets = function () {
        var _this = this;
        this.assetsRequestStatus = 'pending';
        this.assetsService.getAllAssets().subscribe(function (assets) {
            _this.assetsRequestStatus = 'resolved';
            console.log(assets);
            _this.assets = assets;
        }, function (err) {
    ...
    AssetsComponent.prototype.getNonPooledAssets = function () {
        var _this = this;
        this.assetsRequestStatus = 'pending';
        this.assetsService.getNonPooledAssets().subscribe(function (assets) {
            _this.assetsRequestStatus = 'resolved';
            console.log(assets);
            _this.assets = assets;
        }, function (err) {
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
        __metadata("design:type", Boolean)
    ], AssetsComponent.prototype, "showNonPooledAssetOnly", void 0);
    __decorate([
...
var DashboardSponserComponent = (function () {
    function DashboardSponserComponent(location, userService, router, walletService) {
        this.location = location;
        this.userService = userService;
        this.router = router;
...
module.exports = "<app-header></app-header>\n\n<div class=\"main-content\">\n  <div class=\"container-fluid\">\n    <div class=\"row\">\n      <div class=\"col-md-6 col-md-offset-3\">\n        <div class=\"card\">\n          <div class=\"card-header\" data-background-color=\"green\">\n            <h4 class=\"title\">Change Password</h4>\n            <p class=\"category\">for security purpose please change your initial password</p>\n          </div>\n          <div class=\"card-content\">\n            <form>\n              <div class=\"row\">\n                <div class=\"col-md-12\">\n                  <div class=\"form-group\">\n                        <label for=\"oldPass\" class=\"control-label\" style=\"font-size: 13px;\">Old Password</label>\n                        <input id=\"oldPass\" type=\"password\" [(ngModel)]=\"credential.oldPassword\" name=\"oldPassword\" class=\"form-control\" >\n\n                  </div>\n\n                  <div class=\"form-group\">\n                    <label for=\"newPass\" class=\"control-label\" style=\"font-size: 13px;\">New Password</label>\n                    <p class=\"text-gray\" style=\"font-size: 11px;\">\n                      ({{passwordFormatText}})\n                    </p>\n                    <input id=\"newPass\" type=\"password\" [(ngModel)]=\"credential.newPassword\" name=\"newPassword\" class=\"form-control\" >\n\n                  </div>\n\n                  <div class=\"form-group\">\n\n                    <label for=\"rePass\" class=\"control-label\" style=\"font-size: 13px;\">Confirm Password</label>\n                    <input id=\"rePass\" type=\"password\" [(ngModel)]=\"credential.rePassword\" name=\"rePassword\" class=\"form-control\" >\n\n                  </div>\n\n                    <button\n                            [disabled]=\"passwordChangeRequestStatus==='pending'\n                            || credential.oldPassword.length<6\n                            || credential.newPassword.length<6\n                             || credential.newPassword!==credential.rePassword\"\n                            type=\"submit\"\n                            (click)=\"changePassword()\"\n                            class=\"btn btn-danger pull-right\">Save\n                    </button>\n                  </div>\n                </div>\n\n\n\n\n\n            </form>\n          </div>\n        </div>\n      </div>\n\n    </div>\n  </div>\n</div>"
...
var UserCreateComponent = (function () {
    function UserCreateComponent(userService, toastService, router) {
        ...
        this.user = { password: '', role: 'farmer', profiles: { name: '', phone: '' } };
...
var AssetsPoolService = (function () {
    ...
    AssetsPoolService.prototype.getPoolsByIssuerName = function () {
        var _this = this;
        return this.userService.user.concatMap(function (user) {
...
var AssetsService = (function () {
    ...
    AssetsService.prototype.getAllAssets = function () {
        var _this = this;
        var url = "" + __WEBPACK_IMPORTED_MODULE_1__api_config__["a" /* AssetApi */].getAssets.url();
        return this.http.get("" + url)
            .retry(3)
            .catch(function (res) {
            return _this.errorHandler.handle(res);
    ...
    AssetsService.prototype.getNonPooledAssets = function () {
        var _this = this;
...
var TokenService = (function () {
    ...
    TokenService.prototype.getTokens = function () {
        var _this = this;
        var url = __WEBPACK_IMPORTED_MODULE_1__api_config__["f" /* TokenApi */].getTokens.url() + "?filter[include]=assetpool";
        return this.http.get("" + url)
            .catch(function (res) {
            return _this.errorHandler.handle(res);
        });
    ...
    TokenService.prototype.getAllTokensByAddressFromBlockchain = function () {
        var _this = this;
        var url = "" + __WEBPACK_IMPORTED_MODULE_1__api_config__["f" /* TokenApi */].getTokensByAddressFromBlockchain.url();
    ...
    TokenService.prototype.getAllTokensFromBlockchain = function () {
        var _this = this;
        var url = "" + __WEBPACK_IMPORTED_MODULE_1__api_config__["f" /* TokenApi */].getAllTokensFromBlockchain.url();
        return this.http.get("" + url)
            .catch(function (res) {
            return _this.errorHandler.handle(res);
        });
...
var UserService = (function () {
    ...
    UserService.prototype.login = function (user) {
        var _this = this;
        return this.http.post(__WEBPACK_IMPORTED_MODULE_1__api_config__["g" /* UserApi */].login.url() + "?include=User", user)
            .do(function (res) {
    ...
    UserService.prototype.register = function (user) {
        ...
        return this.http.post("" + __WEBPACK_IMPORTED_MODULE_1__api_config__["g" /* UserApi */].register.url(), user)
            .concatMap(function (createdUser) {
            createdUser.profiles = user.profiles;
            return _this.createProfile(createdUser);
        })
            .catch(function (res) {
            return _this.errorHandler.handle(res);
        });
    ...
    UserService.prototype.getUser = function () {
        ...
        var _this = this;
        return this.http.get(__WEBPACK_IMPORTED_MODULE_1__api_config__["g" /* UserApi */].findById.url() + "/" + this.getUserIdFromStorage() + "?filter[include]=profiles").do(function (user) {
    ...
    UserService.prototype.createProfile = function (user) {
        ...
        return this.http.post(__WEBPACK_IMPORTED_MODULE_1__api_config__["g" /* UserApi */].updateProfile.url() + "/" + user.id + "/profiles", profile).do(function (profiles) {
        })
            .catch(function (err) {
    ...
    UserService.prototype.updateProfile = function (user) {
        ...
        return this.http.put(__WEBPACK_IMPORTED_MODULE_1__api_config__["g" /* UserApi */].updateProfile.url() + "/" + user.id + "/profiles", profiles).do(function (profile) {
    ...
    UserService.prototype.getUsers = function () {
        var _this = this;
        return this.http.get(__WEBPACK_IMPORTED_MODULE_1__api_config__["g" /* UserApi */].list.url() + "?filter[include]=profiles")
            .catch(function (res) {
            return _this.errorHandler.handle(res);
        });
    };
    ...
    UserService.prototype.sendPasswordResetToken = function (email) {
        var _this = this;
        return this.http.post("" + __WEBPACK_IMPORTED_MODULE_1__api_config__["g" /* UserApi */].sendResetPasswordToken.url(), { email: email }).do(function (res) {
        })
            .catch(function (err) {
            return _this.errorHandler.handle(err);
        });
    ...
    UserService.prototype.resetPassword = function (accessToken, newPassword) {
        var _this = this;
        return this.http.post(__WEBPACK_IMPORTED_MODULE_1__api_config__["g" /* UserApi */].resetPassword.url() + "?access_token=" + accessToken, { newPassword: newPassword }).do(function (data) {
        }).catch(function (res) {
            return _this.errorHandler.handle(res);
        });
    };
    ...
    UserService.prototype.changePassword = function (oldPassword, newPassword) {
        var _this = this;
        return this.http.post("" + __WEBPACK_IMPORTED_MODULE_1__api_config__["g" /* UserApi */].changePassword.url(), { oldPassword: oldPassword, newPassword: newPassword }).do(function (data) {
    ...
    UserService.prototype.logout = function () {
        var _this = this;
        return this.http.post("" + __WEBPACK_IMPORTED_MODULE_1__api_config__["g" /* UserApi */].logout.url(), {}).do(function (data) {
    ...
    UserService.prototype.createAccountOnBlockchain = function () {
        var _this = this;
        return this.http.post("" + __WEBPACK_IMPORTED_MODULE_1__api_config__["d" /* OnboardingApi */].createAccount.url(), { userId: this.dataStore.user.id })
            .do(function (data) {
    ...
    UserService.prototype.getUsersByRole = function (role) {
        ...
        return this.http.get(__WEBPACK_IMPORTED_MODULE_1__api_config__["g" /* UserApi */].list.url() + "?filter[where][role]=" + role)
            .do(function (farmers) {
        })
            .catch(function (res) {
            return _this.errorHandler.handle(res);
    ...
    UserService.prototype.getUsersByOnboardingStatus = function (status) {
        ...
        if (status === 'isPasswordChanged') {
            url = __WEBPACK_IMPORTED_MODULE_1__api_config__["g" /* UserApi */].list.url() + "?filter[where][isPasswordChanged]=true&filter[where][isRegisteredOnBlockchain]=false";
        }
        if (status === 'isRegisteredOnBlockchain') {
            url = __WEBPACK_IMPORTED_MODULE_1__api_config__["g" /* UserApi */].list.url() + "?filter[where][isRegisteredOnBlockchain]=true&filter[where][isIssuerOnBlockchain]=false";
        }
        if (status === 'isIssuerOnBlockchain') {
            url = __WEBPACK_IMPORTED_MODULE_1__api_config__["g" /* UserApi */].list.url() + "?filter[where][isIssuerOnBlockchain]=true";
        }
        return this.http.get("" + url)
            .do(function (farmers) {
            console.log(farmers);
    ...
    UserService.prototype.getBlockchainAccountDuringOnboarding = function () {
        ...
        return __WEBPACK_IMPORTED_MODULE_7_rxjs_Observable__["a" /* Observable */].interval(1000)
            ...
            return _this.http.get(__WEBPACK_IMPORTED_MODULE_1__api_config__["d" /* OnboardingApi */].getAccount.url() + "?address=" + _this.dataStore.user.walletAddress);
        })
            .retry(3)
            .catch(function (res) {
            return _this.errorHandler.handle(res);
    ...
    UserService.prototype.resgisterAsIssuer = function (issuer) {
        var _this = this;
        return this.http.post("" + __WEBPACK_IMPORTED_MODULE_1__api_config__["d" /* OnboardingApi */].resgisterIssuer.url(), issuer).do(function (data) {
...
var WalletService = (function () {
    ...
    WalletService.prototype.getBlockchainAccount = function () {
        ...
        return this.userService.user
            .concatMap(function (user) {
            return _this.http.get(__WEBPACK_IMPORTED_MODULE_1__api_config__["h" /* WalletApi */].getAccount.url() + "?address=" + user.walletAddress);
        })
            .retry(3)
            .catch(function (res) {
            return _this.errorHandler.handle(res);
    ...
    WalletService.prototype.getTransactions = function (senderPublicKey, recipientId) {
        var _this = this;
        return this.http.get(__WEBPACK_IMPORTED_MODULE_1__api_config__["h" /* WalletApi */].getTransaction.url() + "?senderPublicKey=" + senderPublicKey + "&recipientId=" + recipientId)
            .retry(3)
            .catch(function (res) {
            return _this.errorHandler.handle(res);
        });
    ...
    WalletService.prototype.sendTransactions = function (txn) {
        var _this = this;
        return this.http.post("" + __WEBPACK_IMPORTED_MODULE_1__api_config__["h" /* WalletApi */].sendTransaction.url(), txn)
            .catch(function (res) {
            return _this.errorHandler.handle(res);
        });
    };
