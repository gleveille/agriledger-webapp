...
var AssetsComponent = (function () {
    ...
    ], AssetsComponent.prototype, "showFilter", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["D" /* Input */])(),
...
var AssetsService = (function () {
    ...
    AssetsService.prototype.getAllAssets = function () {
        var _this = this;
        var url = __WEBPACK_IMPORTED_MODULE_1__api_config__["a" /* AssetApi */].getAssets.url() + "?filter[include]=user";
        return this.http.get("" + url)
            .retry(3)
            .catch(function (res) {
            return _this.errorHandler.handle(res);
