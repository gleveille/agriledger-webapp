...
var routes = [
    ...
    },
    {
        ...
        children: [
            ...
            { path: 'user-view/:userId', component: __WEBPACK_IMPORTED_MODULE_35__components_user_view_user_view_component__["a" /* UserViewComponent */] },
        ]
    },
    { path: '**', redirectTo: '' }
];
...
var AssetsService = (function () {
    ...
    AssetsService.prototype.addAssetToFavourite = function (assetId, userId) {
        ...
        var data = { assetId: assetId, userId: userId };
        return this.http.post("" + url, data)
            .do(function (asset) {
            console.log('fav assets are');
            console.log(asset);
            _this.dataStore.favouriteAssets.push(asset);
            _this._favouriteAssets.next(_this.dataStore.favouriteAssets);
        })
            .catch(function (res) {
            return _this.errorHandler.handle(res);
