    ...
    AssetPoolCreateComponent.prototype.getCategories = function () {
        ...
        this.assetsService.getCategories().subscribe(function (categories) {
            ...
            if (_this.selectedAssetsForPool.length) {
                ...
                if (arr[0]) {
                    _this.category.one = _this.assetCategoriesLevelOne[arr[0]].name;
                }
                if (arr[1]) {
                    _this.category.two = _this.assetCategoriesLevelOne[arr[0]]
                        .subCategories[arr[1]].name;
                }
                if (arr[2]) {
                    _this.category.three = _this.assetCategoriesLevelOne[arr[0]]
                        .subCategories[arr[1]]
                        .subCategories[arr[2]].name;
                }
                if (arr[3]) {
                    _this.category.four = _this.assetCategoriesLevelOne[arr[0]]
                        .subCategories[arr[1]]
                        .subCategories[arr[2]]
                        .subCategories[arr[3]].name;
                }
                if (arr[4]) {
                    _this.category.five = _this.assetCategoriesLevelOne[arr[0]]
                        .subCategories[arr[1]]
                        .subCategories[arr[2]]
                        .subCategories[arr[3]]
