...
var TokenApi = {
    getTokens: {
        url: function () { return ServerUrl + '/api/blockchain/token/getTokens'; },
        method: 'GET',
        query: ['address']
    },
};
...
var AssetPoolListComponent = (function () {
    function AssetPoolListComponent(assetPoolService, router, modalService, toastService, userService) {
        ...
        this.selectedPool = { maximum: null, precision: null, blockchain: { currency: null } };
    }
...
var AssetsPoolService = (function () {
    ...
    AssetsPoolService.prototype.issueToken = function (amount, exchangeRate, precision, currency) {
        var _this = this;
...
var TokenService = (function () {
    ...
    TokenService.prototype.getTokens = function () {
        var _this = this;
        var url = "" + __WEBPACK_IMPORTED_MODULE_1__api_config__["d" /* TokenApi */].getTokens.url();
        return this.userService.getUser()
