...
var AssetsComponent = (function () {
    ...
    AssetsComponent.prototype.ngOnInit = function () {
        ...
        this.assetsService.assets.subscribe(function (assets) {
            if (_this.showNonPooledAssetOnly) {
...
var DashboardSponserComponent = (function () {
    ...
    DashboardSponserComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.assetService.loadAllAssets().subscribe(function () {
        }, function (err) {
        });
        this.assetService.loadStat().subscribe(function () {
        }, function (err) {
        });
        this.userService.user.subscribe(function (user) {
            if (!user.id) {
                ...
                _this.assetService.loadFavouriteAssets(user.id).subscribe(function () {
                }, function (err) {
                });
            }
        });
...
module.exports = "<div class=\"row\" style=\"text-align: center;padding:5px;margin: 5px;\">\n\n  <div class=\"col-xs-12\" *ngIf=\"!_documents.length\">\n    <div class=\"row\" >\n      <div class=\"col-xs-12 text-center\">\n        <h5 class=\"text-gray\">\n          No Documents uploaded\n        </h5>\n      </div>\n    </div>\n\n  </div>\n\n    <div class=\"row\">\n      <div class=\"col-xs-12 col-md-3 text-center text-gray\" *ngFor=\"let document of _documents\">\n        <a [href]=\"document.url\" target=\"_blank\" download>\n          <img [src]=\"serverUrl+document.url\" class=\"documentsImage\">\n\n        </a>\n        <p style=\"text-wrap: normal;word-wrap: break-word\">\n          {{document?.description||'No description added'}}\n        </p>\n        <div>{{document?.date|moment}}</div>\n        <div style=\"text-wrap: normal;word-wrap: break-word\">{{document?.hash}}</div>\n        <div>{{document?.lat}},{{document?.long}}</div>\n\n        <div>\n          <button  class=\"btn btn-simple\" *ngIf=\"document && document.status==='rejected'\">Rejected</button>\n\n          <button class=\"btn btn-simple\" *ngIf=\"document && document.status==='approved'\">Approved</button>\n\n          <button class=\"btn btn-primary  btn-simple\" *ngIf=\"document && document.status==='pending'\">Pending</button>\n\n        </div>\n\n      </div>\n\n\n    </div>\n\n\n\n\n  </div>\n\n\n"
...
var UserCreateComponent = (function () {
    ...
    UserCreateComponent.prototype.resetForm = function () {
        ...
        for (var _d = 0, _e = Object.keys(this.user.profiles.farmDetails); _d < _e.length; _d++) {
            var key = _e[_d];
...
module.exports = "<div class=\"main-content\">\n  <div class=\"container-fluid\">\n\n    <button class=\"btn btn-simple\" (click)=\"goBack()\" style=\"margin: 0;\">\n      <i class=\"material-icons\">keyboard_return</i>Back\n    </button>\n    <div class=\"row\">\n      <div class=\"col-xs-12\">\n        <ul class=\"nav nav-pills nav-pills-info\" style=\"background-color:#00bcd41c;padding:8px;\">\n          <li class=\"active\"><a href=\"#profile\" data-toggle=\"tab\">User Details</a></li>\n          <li><a href=\"#user_documents\" data-toggle=\"tab\">User Documents</a></li>\n          <li><a href=\"#assets\" data-toggle=\"tab\">User Assets</a></li>\n        </ul>\n      </div>\n      <div class=\"col-xs-12\">\n\n\n        <div class=\"card card-stats\" >\n\n          <div class=\"card-content\">\n            <div class=\"tab-content\">\n              <div class=\"tab-pane active\" id=\"profile\">\n                <div class=\"row\" style=\"text-align: center\" id=\"\">\n                  <h3>User Details</h3>\n                  <div class=\"row\" style=\"padding: 15px\">\n\n\n                    <div class=\"col-lg-6\" >\n\n                      <div class=\"row\" style=\"text-align: left\">\n                        <hr>\n\n                        <div class=\"col-xs-4 text-left\">\n                          <b>AgriId</b>\n                        </div>\n                        <div class=\"col-xs-8 text-right\">\n                          <span class=\"text-gray\">{{user?.id}}</span>\n                        </div>\n                      </div>\n\n\n                      <div class=\"row\" style=\"text-align: left\">\n                        <hr>\n\n                        <div class=\"col-xs-4 text-left\">\n                          <b>Name</b>\n                        </div>\n                        <div class=\"col-xs-8 text-right\">\n                          <span class=\"text-gray\">{{user?.profiles?.name}}</span>\n                        </div>\n                      </div>\n\n\n                      <div class=\"row\" style=\"text-align: left\">\n                        <hr>\n\n                        <div class=\"col-xs-4 text-left\">\n                          <b>Email</b>\n\n\n                        </div>\n                        <div class=\"col-xs-8 text-right\">\n                      <span class=\"text-gray\">\n                      {{user?.email}}\n                      </span>\n                        </div>\n                      </div>\n\n\n                      <div class=\"row\" style=\"text-align: left\">\n                        <hr>\n\n                        <div class=\"col-xs-4 text-left\">\n                          <b>Phone</b>\n\n\n                        </div>\n                        <div class=\"col-xs-8 text-right\" >\n                      <span class=\"text-gray\">\n                      {{user?.profiles?.phone}}\n                      </span>\n                        </div>\n                      </div>\n\n                      <div class=\"row\" style=\"text-align: left\">\n                        <hr>\n\n                        <div class=\"col-xs-6 text-left\">\n                          <b>Address Line1</b>\n\n\n                        </div>\n                        <div class=\"col-xs-6 text-right\">\n                    <span class=\"text-gray\">\n                      {{user?.profiles?.address?.line1}}\n\n                    </span>\n\n                        </div>\n                      </div>\n\n                      <div class=\"row\" style=\"text-align: left\">\n                        <hr>\n\n                        <div class=\"col-xs-4 text-left\">\n                          <b>Address Line2</b>\n\n\n                        </div>\n                        <div class=\"col-xs-8 text-right\">\n                    <span class=\"text-gray\">\n                      {{user?.profiles?.address?.line2}}\n\n                    </span>\n\n                        </div>\n                      </div>\n\n                      <div class=\"row\" style=\"text-align: left\">\n                        <hr>\n\n                        <div class=\"col-xs-4 text-left\">\n                          <b>Member since</b>\n\n\n                        </div>\n                        <div class=\"col-xs-8 text-right\">\n                    <span class=\"text-gray\">\n                      {{user?.createdAt|moment:true}}\n\n                    </span>\n\n                        </div>\n                      </div>\n\n                      <div class=\"row\" style=\"text-align: left\">\n                        <hr>\n\n                        <div class=\"col-xs-4 text-left\">\n                          <b>Last Login</b>\n\n\n                        </div>\n                        <div class=\"col-xs-8 text-right\">\n                    <span class=\"text-gray\">\n                      {{user?.lastLoggedIn|moment}}\n\n                    </span>\n\n                        </div>\n                      </div>\n\n\n\n                    </div>\n                    <div class=\"col-lg-6\" >\n\n                      <div class=\"row\" style=\"text-align: left\">\n                        <hr>\n\n\n                        <div class=\"col-xs-4 text-left\">\n                          <b>Wallet address</b>\n\n\n                        </div>\n                        <div class=\"col-xs-8 text-right\" >\n                      <span class=\"text-gray\">\n                      {{user.walletAddress || 'N.A'}}\n                    </span>\n                        </div>\n\n                      </div>\n\n\n                      <div class=\"row\" style=\"text-align: left\">\n                        <hr>\n\n\n                        <div class=\"col-xs-4 text-left\">\n                          <b>Registration no.</b>\n\n\n                        </div>\n                        <div class=\"col-xs-8 text-right\" >\n                      <span class=\"text-gray\">\n                      {{user?.profiles?.registration}}\n                    </span>\n                        </div>\n\n                      </div>\n\n                      <div class=\"row\" style=\"text-align: left\">\n                        <hr>\n\n                        <div class=\"col-xs-4 text-left\">\n                          <b>Company</b>\n\n\n                        </div>\n                        <div class=\"col-xs-8 text-right\" >\n                      <span class=\"text-gray\">\n                      {{user?.profiles?.company}}\n                      </span>\n                        </div>\n\n                      </div>\n\n\n\n                      <div class=\"row\" style=\"text-align: left\">\n                        <hr>\n\n                        <div class=\"col-xs-4 text-left\">\n                          <b>City</b>\n\n\n                        </div>\n                        <div class=\"col-xs-8 text-right\">\n                    <span class=\"text-gray\">\n                      {{user?.profiles?.address?.city}}\n\n                    </span>\n\n                        </div>\n                      </div>\n\n                      <div class=\"row\" style=\"text-align: left\">\n                        <hr>\n\n                        <div class=\"col-xs-4 text-left\">\n                          <b>Province</b>\n\n\n                        </div>\n                        <div class=\"col-xs-8 text-right\">\n                    <span class=\"text-gray\">\n                      {{user?.profiles?.address?.province}}\n\n                    </span>\n\n                        </div>\n                      </div>\n                      <div class=\"row\" style=\"text-align: left\">\n                        <hr>\n\n                        <div class=\"col-xs-4 text-left\">\n                          <b>Wechat ID</b>\n\n\n                        </div>\n                        <div class=\"col-xs-8 text-right\">\n                    <span class=\"text-gray\">\n                      {{user?.profiles?.weChat}}\n\n                    </span>\n\n                        </div>\n                      </div>\n\n                      <div class=\"row\" style=\"text-align: left\">\n                        <hr>\n\n                        <div class=\"col-xs-4 text-left\">\n                          <b>Registered on Blockchain?</b>\n\n\n                        </div>\n                        <div class=\"col-xs-8 text-right\">\n                    <span class=\"text-gray\">\n                      {{user?.isRegisteredOnBlockchain?'Yes':'No'}}\n\n                    </span>\n\n                        </div>\n                      </div>\n\n                      <div class=\"row\" style=\"text-align: left\">\n                        <hr>\n\n                        <div class=\"col-xs-4 text-left\">\n                          <b>Issuer on Blockchain</b>\n\n\n                        </div>\n                        <div class=\"col-xs-8 text-right\">\n                    <span class=\"text-gray\">\n                      {{user?.isIssuerOnBlockchain?'Yes':'No'}}\n\n                    </span>\n\n                        </div>\n                      </div>\n\n                    </div>\n                  </div>\n\n\n                </div>\n              </div>\n\n              <div class=\"tab-pane\" id=\"user_documents\">\n                <app-document-list [documents]=\"user?.profiles?.documents\" [documentType]=\"'user_documents'\">\n\n                </app-document-list>\n              </div>\n\n              <div class=\"tab-pane\" id=\"assets\">\n                Asset Details\n              </div>\n            </div>\n\n\n\n\n          </div>\n\n\n\n\n        </div>\n      </div>\n    </div>\n  </div>\n\n\n\n</div>\n"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__api_config__ = __webpack_require__("../../../../../src/app/api.config.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var UserViewComponent = (function () {
    function UserViewComponent(activatedRoute, router, toastService, location, userService) {
        this.activatedRoute = activatedRoute;
        this.router = router;
        this.toastService = toastService;
        this.location = location;
        this.userService = userService;
        this.serverUrl = __WEBPACK_IMPORTED_MODULE_5__api_config__["f" /* ServerUrl */];
        this.user = {};
    }
    UserViewComponent.prototype.ngOnInit = function () {
        ...
        this.activatedRoute.params.concatMap(function (param) {
            console.log(param);
            return _this.userService.getUserById(param.userId);
...
var UserService = (function () {
    ...
    UserService.prototype.createProfile = function (user) {
        ...
        return this.http.post(__WEBPACK_IMPORTED_MODULE_1__api_config__["h" /* UserApi */].updateProfile.url() + "/" + user.id + "/profiles", profile).do(function (profiles) {
        })
            .catch(function (err) {
...
var WalletService = (function () {
    ...
    WalletService.prototype.getBlockchainAccount = function () {
        ...
        return this.userService.user
            .concatMap(function (user) {
            return _this.http.get(__WEBPACK_IMPORTED_MODULE_1__api_config__["i" /* WalletApi */].getAccount.url() + "?address=" + user.walletAddress);
        })
            .retry(3)
            .catch(function (res) {
            return _this.errorHandler.handle(res);
